...
fun FolderScreen(
    ...
    val folder = state.filter as SongFilter.Folder
    LazyColumn(
        modifier = Modifier
            .fillMaxSize()
        ...
        item {
            ...
            Column(
                ...
                Text(
                    text = "${folder.folder.songs.size} Songs",
                    modifier = Modifier
                        .padding(top = 16.dp)
                        .align(Alignment.CenterHorizontally),
                    fontSize = 14.sp,
                ...
                Row(
                    ...
                    Button(
                        ...
                        onClick = { onEvent(SongEvent.Change(folder.folder.songs, 0)) },
                        colors = ButtonColors(
                            containerColor = Gray,
                            contentColor = Blue,
                    ...
                    Button(
                        ...
                        onClick = {
                            onEvent(SongEvent.Shuffle(folder.folder.songs))
                        },
                        colors = ButtonColors(
                            containerColor = Gray,
                            contentColor = Blue,
        ...
        items(folder.folder.songs.size, key = { folder.folder.songs[it].id }) {
            Song(
                state = state,
                songs = folder.folder.songs,
                position = it,
